...
We provide DINOv2-B/L baselines and Franca-B/L models before and after HRFT at 518px, plus the existing
Franca-G model. Franca-B and the DINOv2 baselines use IN-21K; Franca-L and Franca-G use LAION-600M.
...
The RASA heads extracted from the three new HRFT teacher checkpoints have the expected 10-tensor structure. The
loader also supports legacy 9-tensor RASA checkpoints by inferring the number of preprocessing projections.
