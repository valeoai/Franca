...
class DinoVisionTransformer(nn.Module):
    ...
    def interpolate_pos_encoding(self, x, w, h):
        ...
        if self.interpolate_offset:
            ...
            # Note: still needed for backward-compatibility,
            # the underlying operators are using both output size and scale factors
...
def vit_2B(patch_size=16, num_register_tokens=0, **kwargs):
...
def vit_3B(patch_size=16, num_register_tokens=0, **kwargs):
...
def vit_7B(patch_size=16, num_register_tokens=0, **kwargs):
